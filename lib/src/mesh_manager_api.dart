...
class MeshManagerApi {
  ...
  Future<bool> sendVendorMessage({
    ...
    await _methodChannel.invokeMethod('sendValueVendorModel', {
      "address" :address,
      'modelName': modelName,     // just for debugging/logging
      'modelId': modelId,
      'companyId': companyId,
      'opCode': opCode,
      'keyIndex': keyIndex,
  ...
  Future<ConfigModelAppStatusData> sendConfigModelAppBind(int nodeId, int elementId, int modelId,
    ...
    print("➡️ sendConfigModelAppBind called with:");
    print("   nodeId: $nodeId, elementId: $elementId, modelId: $modelId, appKeyIndex: $appKeyIndex");
    ...
    print("✅ ConfigModelAppStatusData received: $status");
