...
enum DoozMeshManagerApiChannel {
    ...
    case sendValueVendorModel(_ data: SendValueVendorModelArguments)
    ...
    init(call: FlutterMethodCall) {
        ...
        do{
            ...
            case "sendValueVendorModel":
                 self = .sendValueVendorModel(try SendValueVendorModelArguments(arguments))
