...
import 'package:leafybot_flutter_app/mesh/mesh_setup_option.dart';
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            // Leafybot Count
            _buildLabel(context, "How many Leafybot do you have?"),
            const SizedBox(height: 10),
            _numberDropdownWidget(context, selected_leafybot_count),
            ...
            CustomButton(
              ...
              onPressed: () {
                ...
                if ((selected_leafybot_count.value <= 0) &&
                  ...
                  Get.to(MeshSetupOption(
                    leafybot_count: selected_leafybot_count.value,
