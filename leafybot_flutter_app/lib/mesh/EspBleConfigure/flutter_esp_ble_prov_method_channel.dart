...
class MethodChannelFlutterEspBleProv extends FlutterEspBleProvPlatform {
  ...
  @override
  Future<dynamic> customData(String deviceName, String proofOfPossession,
      String data, String path) async {
    final args = {
      'deviceName': deviceName,
      'proofOfPossession': proofOfPossession,
      'data': data,
    ...
    return await methodChannel.invokeMethod<dynamic>('customData', args);
  }
}
