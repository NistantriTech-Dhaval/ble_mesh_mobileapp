  ...
  Widget build(BuildContext context) {
    ...
    if (_bottomNavigationBarIndex == homeTab) {
      ...
      body = ScanningAndProvisioning(
          ...
          onGoToControl: () {
            setState(() {
              _bottomNavigationBarIndex = homeTab;
            });
          });
    ...
    return MaterialApp(
      ...
      home: ScaffoldMessenger(
        key: _scaffoldKey,
        child: Scaffold(
          appBar: AppBar(title: Text("Ble Mesh App IOS"),),
          body: body,
          bottomNavigationBar: BottomNavigationBar(
            ...
            onTap: (newBottomNavigationBarIndex) {
              if (nordicNrfMesh.meshManagerApi.meshNetwork != null) {
                ...
                _scaffoldKey.currentState!.showSnackBar(const SnackBar(content: Text('IOS Please load a mesh network')));
              }
            },
            items: const [
